...
namespace WizLib_DataAccess.Migrations
{
    ...
    [Migration("20220518122546_AddOManyToManyFluentBookAndAuthor")]
    partial class AddOManyToManyFluentBookAndAuthor
    {
            ...
            modelBuilder.Entity("WizLib_Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("WizLib_Model.Models.Fluent_Detail", "Fluent_Detail")
                        .WithOne("Fluent_Book")
                        .HasForeignKey("WizLib_Model.Models.Fluent_Book", "Detail_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
